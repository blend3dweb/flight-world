...
if(offlineRender||params.has('test'))window.flight.inspect=()=>({scene,camera,renderer,aircraft,cockpit,atmosphere,water,vegetation,city,roofMat,windowTex,ocean,ground,islandHeight,islands,infrastructure,forest,forestPoints,reservedLand,PADS});
